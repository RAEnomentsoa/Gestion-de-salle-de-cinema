                                    ...
                                    <form method="POST" action="AjouterClientServlet">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input
                                                  ...
                                                  placeholder="Ex: John Doe" value="<%= client.getNom() != null ? client.getNom() : "" %>" required />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input
                                                  ...
                                                  placeholder="Ex: 123 rue du Cinéma" value="<%= client.getAddress() != null ? client.getAddress() : "" %>" />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input
                                                  ...
                                                  placeholder="Ex: 25" value="<%= client.getAge() != null ? client.getAge() : "" %>" />
                                        </div>
